...
const SelectTicketsToCancelStep = ({
  onClose,
  order,
  onSuccess,
  ...
  const totalDiscount = useMemo(() => order?.total_discount ?? 0, [order]);
  ...
  const onSubmit: SubmitHandler<FormTypes> = useCallback(
    ...
    [order?.id, postCancelTicketAsync, t, onSuccess]
  );
            ...
            current_operator_rules.map((rule, index) => (
              ...
              >
                ...
                <div className="flex w-full flex-col text-sm">
                  ...
                  <table className="!mx-1 w-full border border-gray-300 text-sm">
  ...
  return (
    <>
      {!order ? (
        <div>
          {t("dialog.create-cancel-ticket-request-dialog.messages.no_order")}
        </div>
      ) : (
        <>
            ...
            <FormProvider {...methods}>
              ...
              >
                <div className="flex flex-col gap-2 rounded-md bg-gray-100 p-2">
                  ...
                  <div className="flex w-full gap-1 text-sm font-semibold text-primary-500">
                    <span>
                      {t(
          ...
          <DialogFooter className="flex gap-3">
            <Button variant={"outline"} onClick={onClose}>
              {t("dialog.create-cancel-ticket-request-dialog.buttons.cancel")}
            </Button>
            <Button
              variant={"default"}
...
export default memo(SelectTicketsToCancelStep);
