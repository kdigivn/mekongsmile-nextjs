  ...
  return (
    ...
    >
      ...
      >
        ...
        <RiFileListLine className="absolute inset-0 h-full w-full text-primary-500 dark:text-primary-400" />
        <FiSearch className="absolute inset-0 m-auto h-10 w-10 text-primary-700 dark:text-primary-300" />
      </motion.div>
      <motion.h2
      ...
      >
        Vui lòng đợi trong khi chúng tôi kiểm tra thông tin đơn hàng của bạn
      </motion.p>
      <motion.div
        initial={{ scale: 0.8, opacity: 0 }}
        animate={{ scale: 1, opacity: 1 }}
